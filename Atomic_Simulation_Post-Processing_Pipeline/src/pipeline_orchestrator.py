...
def csv_export(initial_atom_data_list, all_analysis_results, params, analysis_level_name):
    ...
    for result_atom_data in all_analysis_results:
        ...
        combined_data = {
            ...
            'cu_fraction_2nd_shell_temporal': original_temporal_data.get('cu_fraction_2nd_shell_temporal', np.nan),
            'zr_fraction_2nd_shell_temporal': original_temporal_data.get('zr_fraction_2nd_shell_temporal', np.nan),
            'mean_3rd_neighbor_volume_temporal': original_temporal_data.get('mean_3rd_neighbor_volume_temporal', np.nan),
            'std_3rd_neighbor_volume_temporal': original_temporal_data.get('std_3rd_neighbor_volume_temporal', np.nan),
            'mean_3rd_neighbor_free_volume_temporal': original_temporal_data.get('mean_3rd_neighbor_free_volume_temporal', np.nan),
            'mean_3rd_neighbor_pentagon_fraction_temporal': original_temporal_data.get('mean_3rd_neighbor_pentagon_fraction_temporal', np.nan),
            'mean_3rd_neighbor_CN_temporal': original_temporal_data.get('mean_3rd_neighbor_CN_temporal', np.nan),
            'cu_fraction_3rd_shell_temporal': original_temporal_data.get('cu_fraction_3rd_shell_temporal', np.nan),
            'zr_fraction_3rd_shell_temporal': original_temporal_data.get('zr_fraction_3rd_shell_temporal', np.nan),
    ...
    column_order = [
        ...
        'mean_2nd_neighbor_CN_temporal', 'cu_fraction_2nd_shell_temporal', 'zr_fraction_2nd_shell_temporal',
        ...
        'mean_3rd_neighbor_CN_temporal', 'cu_fraction_3rd_shell_temporal', 'zr_fraction_3rd_shell_temporal',
